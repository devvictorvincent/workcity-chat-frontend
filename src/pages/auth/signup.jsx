    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Join WorkCity Chat</h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="victor.test@example.com"
              />
              {errors.email && (
            ...
            <div className="flex items-start">
              <input
                ...
                className="h-4 w-4 mt-1 text-cyan-400 focus:ring-cyan-400 border-gray-300 rounded bg-white/10"
              />
